...
1. Clone the repo:
   ```bash
   git clone https://github.com/yourusername/Full-Stack-Authentication-With-File-Upload.git
   cd Full-Stack-Authentication-With-File-Upload

**2.Install dependencies:**  npm install

**3.Create a .env file (or directly use your credentials in server.js): **CLOUDINARY_CLOUD_NAME=your_cloud_name
